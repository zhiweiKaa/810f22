...
{\bf Course web site}: \url{ionides.github.io/810f22/}
...
{\bf COVID adaptations}. We will follow UM COVID regulations, such as the requirement to wear a face covering during class. Attendance will be in person unless otherwise stated. 
